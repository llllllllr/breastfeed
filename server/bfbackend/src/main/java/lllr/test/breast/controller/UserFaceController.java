...
public class UserFaceController {
    ...
    public String faceRegister(HttpServletRequest request, @RequestParam("file") @NotNull MultipartFile multipartFile) {

        File image = ChangeMultipartFileToFile(multipartFile);
        try {
            faceService.FaceRegister(image);
    ...
    public String faceSign(HttpServletRequest request, @RequestParam("file") @NotNull  MultipartFile multipartFile) {

        File image = ChangeMultipartFileToFile(multipartFile);
        try {
            faceService.FaceSign(image);
        } catch (FaceException e) {
